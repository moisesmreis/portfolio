                ...
                <ol className="timeline-ol">
                    <li className="ml-6">
                        ...
                        <div className="timeline-wrap">
                            ...
                            <div className="timeline-wrap-desc">Estou construindo e trabalhando em projetos em <b>React</b> e <b>Vue</b> e entregando trabalhos de forma autônoma com escalabilidade e segurança - como o <a href="https://lnoticias.com.br/" className="timeline-text-feat underline">LNotícas</a> - enquanto começo uma faculdade de Eng. de Software</div>
                        </div>
                    </li>
                    <li className="ml-6">
                        <span className="timeline-circle">🔥</span>
                        <div className="timeline-wrap">
                            ...
                            <div className="timeline-wrap-desc">Entre 2020 à 2023, eu, voluntariamente, ajudei a fundar o <b>JUDAS, As botas de</b> - um website de divulgação científica e cultural, mantido por pesquisadores do Brasil, Itália e Moçambique. Colaborei na estruturação da UI/UX do projeto e em implementação de funções</div>
                        </div>
                    </li>
                    <li className="ml-6">
